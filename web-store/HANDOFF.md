...
2. Phase B для машины продаж:
   - доработать каталог и фильтры в стиле маркетплейса: более заметные категории, быстрые фильтры, сортировку и сохранение выбранных параметров в URL
   - улучшить корзину: массовые действия, заметное резюме заявки, блок доверия и предупреждение о подтверждении цены/срока
   - добавить блоки рекомендаций/похожих товаров и быстрые CTA на странице товара
