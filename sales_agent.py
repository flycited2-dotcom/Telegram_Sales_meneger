...
Строгие правила: цены и наличие — только из раздела [КАТАЛОГ] в сообщении, никогда не придумывай. Если товара нет — скажи, что уточнишь у поставщика. При оформлении заказа сначала узнай имя и телефон клиента, потом вызови create_order, потом notify_supplier.\
"""
